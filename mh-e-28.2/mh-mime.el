...
;;;; this prevents items named the same, which happens more than you
...
automatically."
  (let* ((file (mml-minibuffer-read-file "Attach file: "))
         ...
         (description (mml-minibuffer-read-description
                       ;; default the name to the same name as the
                       ;; file
                       (file-name-nondirectory file)))
         (dispos (or disposition
                     (mh-mml-minibuffer-read-disposition type))))
    ;; default the directory to the same as the file, too
